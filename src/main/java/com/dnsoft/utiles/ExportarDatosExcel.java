                ...
                for (int j = 0; j < tabla.getRowCount(); j++) {
                    ...
                    if (object != null) {
                        if (validaObjetoNumerico(object.toString())) {
                            ...
                            //jxl.write.NumberFormat currency = new jxl.write.NumberFormat(jxl.write.NumberFormat.CURRENCY_DOLLAR);
                            WritableCellFormat currencyFormat = new WritableCellFormat(currency);

                            Number numero = new Number(i, j + 1, Double.parseDouble(object.toString()), currencyFormat);
                            s.addCell(numero);
                        } else if (validaFecha) {
